data:extend{ -- Add new crafting tab for spaceblock duplications
	...
	{name="spaceblock-dupe-raw",type="item-subgroup",group="spaceblock-duplications",order="b"},
	{name="spaceblock-dupe-oil",type="item-subgroup",group="spaceblock-duplications",order="c"},
	{name="spaceblock-dupe-chem",type="item-subgroup",group="spaceblock-duplications",order="d"},
}